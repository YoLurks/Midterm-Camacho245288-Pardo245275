 ...
 * It includes various shapes like squares, circles, and triangles to create a detailed tree design.
 */
public class Trees extends DrawingObject {
    private ArrayList<DrawingObject> elements;  // List to store various tree components (trunks, foliage, branches)
    private double y;                           // Y-coordinate of the Trees
    private double x;                           // X-coordinate of the Trees
    ...
    public Trees(){
        ...
        // Adding trunks (rectangles and squares)
        ...
        // Adding foliage (circles for leaves)
        ...
        // Adding branches (triangles and squares for additional trunk structures)
        ...
        // Additional foliage circles for more detailed leaves
        ...
        // Additional foliage branches (triangles)
     ...
     * 
     * @param g The Graphics2D object used for rendering the tree.
     */
    @Override
    ...
    public void moveDown(double amount) {
        for (DrawingObject obj : elements) {
            obj.setY(obj.getY() + amount);  // Move each element down by the specified amount
        }
    }

    /**
     * Gets the Y coordinate of the Trees.
     * 
    ...
    /**
     * Gets the X coordinate of the Trees.
     * 
